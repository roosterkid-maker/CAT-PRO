...
exports.spreadEngine = exports.SpreadEngine = void 0;
class SpreadEngine {
    calculate(pair) {
        ...
        const rawSpreadPercent = (rawSpread / buyPrice) * 100;
        ...
        return {
            ...
            estimatedFees: 0,
            netProfit: rawSpread,
            netProfitPercent: rawSpreadPercent,
...
exports.SpreadEngine = SpreadEngine;
exports.spreadEngine = new SpreadEngine();
//# sourceMappingURL=SpreadEngine.js.map