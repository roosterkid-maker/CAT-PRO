  ...
  try {
    ...
    assert.equal(
      indexedMarkets
        ...
        ?.size,
      2,
      "The hot scanner index must expose both executable BTC venues.",
    );
    ...
    assert.equal(
      ...
      "The hot scanner index must reuse the authoritative cached quote.",
    );
    ...
    assert.equal(
      indexedMarkets
        ...
        ?.size,
      1,
      "The hot scanner index must keep unrelated markets isolated.",
    );
