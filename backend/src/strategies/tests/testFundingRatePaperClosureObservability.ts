...
const economics: FundingRateArbitrageEconomicsSnapshot = {
  ...
  assessments: [{
    ...
    differential: {
      ...
      longNormalizedDailyFundingRate: 0.00015,
      shortNormalizedDailyFundingRate: 0.000294,
    ...
    economics: {
      ...
      modeledLongFundingPeriods: 6,
      modeledShortFundingPeriods: 6,
      ...
      slippageReserveQuote: 0,
      slippageReservePercent: 0,
