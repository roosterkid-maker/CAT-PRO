...
async function main(): Promise<void> {
  ...
  console.log(
    "Binance/Bybit SPOT fixtures proved acknowledgement-is-not-fill, exact execution-ID dedupe, delayed-fill convergence, reconnect isolation, additional-fee preservation, cancel-race monotonicity and durable replay without any order submission.",
  );
}
