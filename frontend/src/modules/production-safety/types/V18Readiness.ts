...
export type V18AcceptanceGateCategory =
  | "PERSISTENCE"
  | "RECOVERY"
  | "ACCOUNTING"
  | "SECURITY"
...
export interface V18ProductionReadinessReport {
  ...
  gates: V18AcceptanceGate[];

  blockers: {
    v18Acceptance: string[];
...
export interface V18ProductionReadinessResponse {
  success: boolean;
